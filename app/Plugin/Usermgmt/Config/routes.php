...
Router::connect('/update_profile/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'update_profile'));
...
Router::connect('/generate_all_permissions', array('plugin' => 'usermgmt', 'controller' => 'user_group_permissions', 'action' => 'generate_all_permissions'));
