...
Thanks,\n" .
    ...
    public function createFromSocialProfile($incomingProfile) {
        ...
        $socialUser['User']['user_group_id'] = 4; // by default all social logins will have a role of bishop
        $socialUser['User']['first_name'] = $incomingProfile['SocialProfile']['first_name']; // by default all social logins will have a role of bishop\
        $socialUser['User']['last_name'] = $incomingProfile['SocialProfile']['last_name']; // by default all social logins will have a role of bishop
        ...
        $socialUser['User']['active'] = 1;
        $socialUser['User']['email_verified'] = 1;
        $socialUser['User']['link'] = $incomingProfile['SocialProfile']['link'];
        $socialUser['User']['avatar'] = $incomingProfile['SocialProfile']['picture'];
        // save and store our ID
        $this->save($socialUser);
        $socialUser['User']['id'] = $this->getLastInsertID();
        return $socialUser;
    }
