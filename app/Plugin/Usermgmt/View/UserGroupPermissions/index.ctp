...
<div class="row">
    ...
    <div class="widget stacked">
        <div class="widget-header">
            <h3><?php echo __('User Group Permissions'); ?></h3>
        </div>
                ...
                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                    ...
                    <tbody>
                        ...
                        for ($i = 1; $i <= count($allControllers) - 2; $i++) {
                            ?>
                            <tr>
                                <td><a href="<?php echo SITE_URL . "permissions/?c=" . $i; ?>"><?php echo $allControllers[$i]; ?></a></td>
                                <td><a href="<?php echo SITE_URL . "permissions/?c=" . $i; ?>" class="btn btn-default btn-xs">
