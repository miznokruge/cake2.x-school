<?php echo $this->element('heading',array('title'=>'About'));?>
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="panel-body">
                    ...
                    <ul>
                        <li>
                            Company : <?php echo $this->Info->config("name");?>
                        </li>
                        <li>
                            Address : <?php echo $this->Info->config("address");?>
                        </li>
                    </ul>
                    <h2>
                        2,160 results found for: <span class="text-navy">""</span>
                    </h2>
                    <small>Request time  (0.23 seconds)</small>
                    <div class="search-form">
                        <form method="get" action="http://webapplayers.com/inspinia_admin-v1.5/index.html">
                            <div class="input-group">
                                <input type="text" class="form-control input-lg" name="search" placeholder="Admin Theme">
                    ...
                    <div class="search-result">
                        ...
                        <a class="search-link" href="#">www.inspinia.com/inspinia</a>
                        <p>
                    ...
                    <div class="search-result">
                        ...
                        <a class="search-link" href="#">https://wrapbootstrap.com/&lrm;</a>
                        <p>
                    ...
                    <div class="search-result">
                        ...
                        <a class="search-link" href="#">https://www.facebook.com/wrapbootstrap&lrm;</a>
                        <p>
                    ...
                    <div class="search-result">
                        ...
                        <a class="search-link" href="#">www.quora.com/Wrapbootstrap&lrm;&lrm;</a>
                        <p>
                    ...
                    <div class="search-result">
                        ...
                        <a class="search-link" href="#">https://wrapbootstrap.com/&lrm;&lrm;</a>
                        <p>
                    ...
                    <div class="search-result">
                        ...
                        <a class="search-link" href="#">https://wrapbootstrap.com/themes/admin&lrm;&lrm;</a>
                        <p>
