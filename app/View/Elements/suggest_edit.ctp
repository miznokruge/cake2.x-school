...
?>
<input type="hidden" name="suggest_id" value="<?php echo $this->Array->Get($suggest,'id');?>">
<h5>Keterangan</h5>
<div class="customer_info">
    <textarea style="width:50%;height:75%;" name="suggest_keterangan" placeholder="Alasan Mengedit Order ini.."><?php echo $this->Array->Get($suggest,'keterangan');?></textarea>
</div>
<h5>Customer</h5>
    <div class="customer_info">
<?php
