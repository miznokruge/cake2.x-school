<div class="row">
		...
		<script src="<?php echo $this->webroot;?>plugins/morris-js/morris.min.js"></script>
	<script src="<?php echo $this->webroot;?>plugins/morris-js/raphael-js/raphael.min.js"></script>
	<!--Sparkline [ OPTIONAL ]-->
	<script src="<?php echo $this->webroot;?>plugins/sparkline/jquery.sparkline.min.js"></script>
	<!--Flot Chart [ OPTIONAL ]-->
	<script src="<?php echo $this->webroot;?>plugins/flot-charts/jquery.flot.min.js"></script>
	<script src="<?php echo $this->webroot;?>plugins/flot-charts/jquery.flot.resize.min.js"></script>
	<!--Flot Pie Chart [ OPTIONAL ]-->
	<script src="<?php echo $this->webroot;?>plugins/flot-charts/jquery.flot.pie.min.js"></script>
	<!--Gauge js [ OPTIONAL ]-->
	<script src="<?php echo $this->webroot;?>plugins/gauge-js/gauge.min.js"></script>
	<!--Easy Pie Chart [ OPTIONAL ]-->
	<script src="<?php echo $this->webroot;?>plugins/easy-pie-chart/jquery.easypiechart.min.js"></script>
	<!--Demo script [ DEMONSTRATION ]-->
	<script src="<?php echo $this->webroot;?>js/demo/nifty-demo.min.js"></script>
	<!--Charts [ SAMPLE ]-->
	<script src="<?php echo $this->webroot;?>js/demo/charts.js"></script>