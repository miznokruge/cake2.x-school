...
DOPENDINGSCRIPT;
    ...
    public function submit($caption = null, $options = array()) {
        ...
        if ($isUrl) {
            ...
            $options['class'] = 'btn btn-primary btn-sm btn-block';
        ...
        $out .= '<h4 id="form_submit_button_fake" style="display:none"><img src="/img/small_loading.gif"/> Submitting...Please wait</h4>';
        $out .= '<script>
                    $(function(){
