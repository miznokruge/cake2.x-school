    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <div class="ibox float-e-margins">
                ...
                <div class="panel-body icons-box">
                    <div>
                        <h3> New Icons in 4.2.0 </h3>
                        <div class="infont col-md-3 col-sm-4"><a href="#"><i class="fa fa-angellist"></i> fa-angellist</a></div>
                        <div class="infont col-md-3 col-sm-4"><a href="http://webapplayers.com/icon/area-chart"><i class="fa fa-area-chart"></i> fa-area-chart</a></div>
                    ...
                    <div>
                        ...
                        <div class="infont col-md-3 col-sm-4"><a href="index-2.html"><i class="fa fa-th-large"></i> fa-th-large</a></div>
