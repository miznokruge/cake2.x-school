...
$html = '';
$html.="Judul : " . $books['Book']['judul'] . '<br>';
$html.="Pengarang : " . $books['Book']['pengarang'] . '<br>';
$html.="No Register : " . $books['Book']['kode_register'] . '<br>';
$params1 = $pdf->serializeTCPDFtagParameters(array($books['Book']['kode_register'], 'C39', '', 45, 60, 18, 0.4, $style, 'N'));
$html.= '<tcpdf method="write1DBarcode" params="' . $params1 . '"/>';
$params2 = $pdf->serializeTCPDFtagParameters(array($books['Book']['kode_register'], 'C128', '', 65, 60, 18, 0.4, $style, 'N'));
$html.= '<tcpdf method="write1DBarcode" params="' . $params2 . '"/>';
$pdf->writeHTML($html, true, false, true, false, '');
$pdf->lastPage();
echo $pdf->Output('Cetak Barcode ' . $books['Book']['judul'] . ' .pdf', 'D');