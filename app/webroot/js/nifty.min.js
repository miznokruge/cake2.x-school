    ...
    n.niftyNoty = function (o) {
        {
            ...
            !function () {
                if ("page" === r.container)
                    t || (t = n('<div id="page-alert"></div>'), nifty.contentContainer.prepend(t)), e = t, r.focus && v(0);
                else if ("floating" === r.container)
                    i[r.floating.position] || (i[r.floating.position] = n('<div id="floating-' + r.floating.position + '" class="floating-container"></div>'), nifty.container.append(i[r.floating.position])), e = i[r.floating.position], r.floating.animationIn && c.addClass("in animated " + r.floating.animationIn), r.focus = !1;
                else {
                    var o = n(r.container),
        ...
        if (a && (e.append(c.html(d)), c.find('[data-dismiss="noty"]').one("click", u), r.closeBtn && c.find(".close").one("click", u), r.timer > 0 && (s = setInterval(u, r.timer)), !r.focus))
            ...
            l = function () {
                ...
                t.each(function () {
                    ...
                    n(document).click(function (t) {
                        ...
                        if (!r) {
                            if (r = i.data("bs.popover").tip(), c = r.find(".popover-title"), f = r.children(".popover-content"), !u && 0 == s.length)
                                return;
