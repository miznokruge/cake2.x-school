...
?>
<div class="row">
    <div class="<?php echo $pluralVar; ?> view col-md-10">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-th-list"></i> <?php echo "<?php echo __('{$singularHumanName}'); ?>"; ?></h3>
            </div> <!-- /panel-header -->
        ...
        foreach ($relations as $alias => $details):
            ...
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-star"></i> <?php echo "<?php echo __('Related " . $otherPluralHumanName . "'); ?>"; ?></h3>
                </div> <!-- /panel-header -->
                <div class="panel-body">
        ...
        if (!empty($associations['hasOne'])) :
            foreach ($associations['hasOne'] as $alias => $details):
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="fa fa-star"></i><?php echo "<?php echo __('Related " . Inflector::humanize($details['controller']) . "'); ?>"; ?></h3>
                    </div> <!-- /panel-header -->
                    <div class="panel-body">
                        <?php echo "<?php if (!empty(\${$singularVar}['{$alias}'])): ?>\n"; ?>
                        <dl>
    ...
    <div class="col-md-2">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title"> <i class="fa fa-star"></i><?php echo "<?php echo __('Actions'); ?>"; ?></h3>
            </div> <!-- /panel-header -->
            <div class="panel-body">
                <ul class="list-group bord-no">
                    <?php echo "\t\t<li class=\"list-group-item\"><?php echo \$this->Html->link(__('<i class=\"fa fa-chevron-left\"></i> Back to Index'), array('action' => 'index'),array('escape'=>false)); ?> </li>\n"; ?>
                    <?php
