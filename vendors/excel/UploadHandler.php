...
/**
 * UploadHandler is server side extension that helps with uploading of files
 *
 * @author Soma Putera
 * @since May 3, 2012
...
//                }
    ...
    public function post($customFileName = null) {
...
//                        $_SERVER['HTTP_X_FILE_NAME'] : $upload['name'][$index],
                      isset($customFileName) ? $customFileName : $upload['name'][$index], 
